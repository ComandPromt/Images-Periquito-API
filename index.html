		...
		<div class="flotar_izquierda">
			...
			<div class="ancho centrar clear">
				...
				<h3>
					...
					<span>It is the same not to put the mode, that is, the result is the same as in the previous examples</span>
				...
				<h3>
					...
					<span>This mode adds the file name plus the current date and time</span>
				...
				<h3>
					...
					<span>This mode gives us the files with numbers</span>
